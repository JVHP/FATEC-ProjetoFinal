                ...
                <div class="col-8">
                    ...
                    <div class="card-body">
                        <dl class="h4">Á vista sai por
                            ...
                            <dd class="h5">em até <span class="text-success">12x R$ {{ number_format(round($peca->vl_peca / 12, 2), 2, ',') }}<span> sem juros!</dd>
                        </dl>
                        <div class="pt-4 my-auto">
                            ...
                            @else
                            <form class="" action="/pedido" method="POST" enctype="multipart/form-data">
                                @csrf

                ...
                <form class="" action="/marcas/{{$marca->id}}" method="POST">
                    ...
                    <div class="p-2">
                        <div class="form-floating">
                            <div class="card p-2">
                                ...
                                <input class="form-check btn-check" id="marca_peca" checked="{{($marca->ck_categoria_marca == 'P') != 0 ? 'true' : 'false'}}" type="radio" name="ck_categoria_marca" value="P">
                                    <label class="btn btn-outline-success my-2 col-5" for="marca_peca">Peça</label>
                                
                                
                                <input class="form-check btn-check" id="marca_carro" checked="{{($marca->ck_categoria_marca == 'C') != 0 ? 'true' : 'false'}}" type="radio" name="ck_categoria_marca" value="C">
                    ...
                    <div class="p-2">
                        <div class="form-floating">
                            ...
                            <textarea aria-describedby="invalid-feedback" class="form-control is-invalid" name="ds_marca" id="ds_marca" maxlength="350" placeholder="Descrição da Marca" value="{{(empty(old('ds_marca'))) ? $marca->ds_marca : (old('ds_marca'))}}"></textarea>
                            <div class="invalid-feedback">
                                {{ $errors->first('ds_marca') }}
                            </div>
                            @else
                            <textarea class="form-control" name="ds_marca" id="ds_marca" maxlength="350" placeholder="Descrição da Marca" value="{{(empty(old('ds_marca'))) ? $marca->ds_marca : (old('ds_marca'))}}"></textarea>
                            @endif

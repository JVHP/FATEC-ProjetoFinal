...
<x-breadcrumb :paginas="$paginas" />
    ...
    <div class="col-12" style="height: 100vh;">
        <div class="card-display border-bottom-orange">
            ...
            <div class="card-body">
                <form class="" action="/gerenciamento-empresas/{{$empresa->id}}" name="edit" method="POST">
                    <div class="row col-12">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-12 text-end p-3 mx-auto">
                            <a href="/gerenciamento-empresas"><button type="button" class="btn btn-danger">Voltar</button></a>

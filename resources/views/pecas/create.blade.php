            ...
            <form class="" action="/pecas" method="POST" enctype="multipart/form-data">
                ...
                <div class="p-2">
                    <div class="form-floating">
                        ...
                        <input aria-describedby="invalid-feedback" class="form-control is-invalid" type="text" name="nm_peca" id="nm_peca" placeholder="Nome Peça" value="{{old('nm_peca')}}">
                        <div class="invalid-feedback">
                            {{ $errors->first('nm_peca') }}
                        </div>
                        @else
                        <input class="form-control" type="text" name="nm_peca" id="nm_peca" placeholder="Nome Peça" value="{{old('nm_peca')}}">
                        @endif
                ...
                <div class="p-2">
                    <div class="form-floating">
                        ...
                        <input aria-describedby="invalid-feedback" class="form-control is-invalid" type="number" step="0.01" name="vl_peca" id="vl_peca" placeholder="Valor" value="{{old('vl_peca')}}">
                        <div class="invalid-feedback">
                            {{ $errors->first('vl_peca') }}
                        </div>
                        @else
                        <input class="form-control" type="number" step="0.01" name="vl_peca" id="vl_peca" placeholder="Valor" value="{{old('vl_peca')}}">
                        @endif
                ...
                <div class="p-2">
                    <div class="form-floating">
                        ...
                        <input class="form-control is-invalid" type="number" name="qt_estoque" id="qt_estoque" placeholder="Estoque" value="{{old('qt_estoque')}}">
                        <div class="invalid-feedback">
                            {{ $errors->first('qt_estoque') }}
                        </div>
                        @else
                        <input class="form-control" type="number" name="qt_estoque" id="qt_estoque" placeholder="Estoque" value="{{old('qt_estoque')}}">
                        @endif

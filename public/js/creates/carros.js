...
function pesquisarInfosFilialCarro() {
...
function pesquisarMarcas(id_empresa) {
    ...
    axios.get(`/marcas-carro-filial/${id_empresa}`)
    .then(resp => {
...
function pesquisarTipos(id_empresa) {
    ...
    axios.get(`/tipos-carro-filial/${id_empresa}`)
    .then(resp => {
...
function montarSelectTipos(tipos) {
    let selectTipos = document.querySelector('#id_tipo_carro');

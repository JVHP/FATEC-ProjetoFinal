...
@section('body')
    ...
    @php
    $paginas = collect([['link' => '/', 'nm_pag' => 'Dashboard'], ['link' => '/pecas', 'nm_pag' => 'Peças'], ['link' => '', 'nm_pag' => 'Editar Peça - ' . $peca->nm_peca]])->collect();
    @endphp
                                ...
                                <div class="col-lg-4 col-12 p-2">
                                    <div class="row col-12">
                                        ...
                                        <div class="col-2 my-auto text-end">
                                            <button id="btn_empresa" type="button"
                                                onclick="pesquisarInfosFilialPeca()"
                                ...
                                <div class="col-lg-4 col-12 p-2">
                                    <div class="form-floating">
                                        ...
                                        <select aria-placeholder="Marca" id="id_marca" class="form-select" name="id_marca">
                                            ...
                                            <option selected value="{{$mrc->id}}">{{$mrc->nm_marca}}</option>
                                            @elseif($mrc->id_empresa == $peca->id_empresa)
                                            <option value="{{$mrc->id}}">{{$mrc->nm_marca}}</option>
                                            @endif
                                            @endforeach
                                        </select>
                                        ...
                                        @else
                                            <select aria-placeholder="Tipo peça" id="id_tipo_peca" class="form-select"
                                                ...
                                                @foreach ($tipos as $tp)
                                                    ...
                                                    @elseif($tp->id_empresa == $peca->id_empresa)
                                                        <option value="{{ $tp->id }}">{{ $tp->nm_tipo }}</option>
                                                    @endif
                                                @endforeach
                                            </select>
